...
public class Main
{
    ...
    private static final String MSG_ERROREN = "il numero inserito non è consentito perchè potrebbe compromettere le funzionalità del gicoco";



    public static final int N=InputDati.leggiIntero(MSG_SCELTA, 3, 10); // scrivere metodo per prendere n e verificare che sia comreso tra 3 e 10
    ...
    public static void main(String[] args){
        ...
        int N= InputDati.leggiIntero(MSG_SCELTA);
